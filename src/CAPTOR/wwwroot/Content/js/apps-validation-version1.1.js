...
function validateEmailAddress(fieldelementid, tooltip_description) {
    var email_address = $(fieldelementid).val();
    if (email_address == "") {
...
//Version1.1 Validation Plugin Starts

//Validate Email

function validateemail(fieldelementid, tooltipdescription) {

}

//Validate Phone

function validatephone(fieldelementid, tooltipdescription) {

}

//Validate TextField

function validatetextfield(fieldelementid, tooltipdescription) {

}

//validate Datepicker

function validatedatepicker(fieldelementid, tooltipdescription) {

}

//validate Single Dropdown

function validatesingledropdown(fieldelementid, tooltipdescription) {

}

//validate Multiselect Dropdown

function validatemultiselectdropdown(fieldelementid, tooltipdescription) {
